						...
						<li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown {{($currentUrl == 'admin.category.index' || $currentUrl == 'admin.category.edit' || $currentUrl == 'admin.category.create' || $currentUrl == 'admin.category.show' || $currentUrl == 'admin.permissions.index' || $currentUrl == 'admin.permissions.edit' || $currentUrl == 'admin.permissions.create') ? 'show' : '' }}" id="sidebarTaskReport">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('admin.completelist')}} " class="nav-link" data-key="t-crm"> Completed List </a>
                                    </li>
									<li class="nav-item">
                                        <a href="{{ route('admin.notcompletelist')}} " class="nav-link" data-key="t-crm"> Non-Completed List </a>
                                    </li>
									<li class="nav-item">
                                        <a href="{{ route('admin.report')}} " class="nav-link"   data-key="t-crm"> Report Release List </a>
                                    </li>
