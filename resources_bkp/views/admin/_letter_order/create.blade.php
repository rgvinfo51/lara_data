...
@section('title', 'Create Letter/Order')
...
<!-- start page title -->
	...
	{!! Form::open(array('route' => 'admin.letter-order.store','method'=>'POST','files' => 'true','enctype'=>'multipart/form-data','id'=>'letterForm')) !!}
	@endcan
 <div class="row">
	<div class="col-lg-12">
		<div class="card">
					...
					<div class="row gy-4">	
						...
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<input type="date" name="order_date" class="form-control" id="labelName" value="{{old('order_date')}}" required>
							</div>
						</div>
						 <!--end col-->
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<input type="text" name="keywords" class="form-control" maxlength="255" id="labelcode" value="">
							</div>
						</div>
						<!--end col-->
						...
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<div id="dropzone" class="dropzone" >
                                    ...
                                    <div class="hidden_images_logo"><input type="hidden" style="display: none;" name="logo_hidden_images" value="{{ old('logo_hidden_images') }}" id="logo_hidden_images" required/>
                                    </div>
	...
	@can('letter_order_add')
		 @can('approval_access')
			<div class="col-xs-12 col-sm-12 col-md-12 text-center">
				<button type="submit" id="submitForm" class="btn btn-primary">{{ __('Create') }}</button>
			</div>
		 @else
			 <div class="col-xs-12 col-sm-12 col-md-12 text-center">
...
<script>
 // Dropzone has been added as a global variable.
	...
	var image = $('#logo_hidden_images').val();
	if(!image){
