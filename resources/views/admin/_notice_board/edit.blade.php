...
<!-- start page title -->
	<div class="row">
		<div class="col-12">
			<div class="page-title-box d-sm-flex align-items-center justify-content-between">
				<h4 class="mb-sm-0">Edit Notice board</h4>
	...
	<!-- end page title -->
	{!! Form::model($notice, ['method' => 'PATCH','route' => ['admin.notice-board.update', $notice->id],'files' => 'true','enctype'=>'multipart/form-data']) !!}
					...
					<div class="row gy-4">	
						...
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<input type="date" name="notice_date" class="form-control" id="labelName" value="{{old('notice_date',date('Y-m-d',strtotime($notice->notice_date)))}}" required>
							</div>
						</div>
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<select name="status" class="form-select" id="statusSelect" required>
									...
									<option {{(old('status',$notice->status) == '1') ? 'selected': ''}} value="1">Active</option>
									<option {{(old('status',$notice->status) == '0') ? 'selected': ''}} value="0">Inactive</option>									 
								</select>
							</div>
						</div>
						 <!--end col-->
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<textarea name="notice_text" class="form-control">{{old('notice_text',$notice->message)}}</textarea>
							</div>
						</div>
						<!--end col-->
						...
						<div class="col-xxl-3 col-md-6">
							<div>
								...
								<div id="dropzone" class="dropzone" >
                                    ...
                                    <div class="hidden_images_logo"><input type="hidden" name="logo_hidden_images" value="{{ old('logo_hidden_images',$notice->upload_file) }}"/>
                                    </div>
